# Phase 04 — Regulatory Context: Geneva Healthcare — Cycle 3
...
**Healthcare AI Governance Stack for Small Geneva Practices (2025-2026):**
...
- nFADP enforcement cases: healthcare data breaches are priority enforcement area
...
- No specific AI regulations, but general security + patient protection obligations apply
...
### Geneva AI for Good Summit (July 2025/2026)
- ITU-hosted global AI governance event in Geneva
- 2025: July — health AI track, AI policy discussions
- 2026: July — Geneva solidifies global AI governance hub position
...
- [ ] If medical device: verify swissdamed registration status
...
- [ ] Assess ISO 42001 relevance for practice
...
**Conclusion:** Healthcare combines highest data sensitivity (Art. 5(c)), highest regulatory stack (nFADP + Swissmedic + cantonal + liability), and highest operational urgency (staffing crisis). nFADP Art. 5(c) is the sharpest entry point across all 4 verticals.

---

## Cycle 3 Additions vs Cycle 2

| Item | Cycle 2 | Cycle 3 Addition |
|---|---|---|
| nFADP | Art. 5(c) + general provisions | FDPIC May 8, 2025 explicit confirmation added |
| Swissmedic | Cantonal + ISO 42001 | swissdamed mandatory July 1, 2026; EU AI Act medical device extension Aug 2027 |
| Federal Council approach | Noted | Confirmed Feb 2025: no comprehensive AI law; sector-specific |
| CoE AI Convention | Signed | Implementation consultation end-2026; healthcare amendments expected |
| Geneva events | None | AI for Good Summit 2025/2026; Geneva Health Forum 2026 |
| ISO 42001 | Named | Confirmed voluntary; SQS/EY/KPMG/ACTAGIS as cert bodies |
| Vaud | Noted | DGVS + CMPR regulatory context added |
| Compliance checklist | Basic | Expanded with swissdamed + DPIA + breach response |

---

*Regulatory context — Phase 04 Cycle 3 complete. swissdamed July 2026 + FDPIC May 2025 + CoE AI Convention + Geneva events integrated.*
